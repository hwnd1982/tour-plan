    ...
    <div class="container">
      ...
      <div class="footer-contact">
        ...
        <div class="footer-contact__form form">
          ...
          <div class="form__input-bar">
            <input type="text" class="form__name" placeholder="Your Full Name*">
            <input type="text" class="form__phone" placeholder="Phone Number*">
            <textarea name="Message" cols="30" rows="5" class="form__message" placeholder="Message"></textarea>
